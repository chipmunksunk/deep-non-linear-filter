...
def evaluate_trained_model(log_dir: str):
    ...
    clean_td, noise_td, est_clean_td, est_noise_td = exp.evaluate_single_utterance(dm.train_dataset, idx=0)
...
if __name__ == "__main__":
    ...
    evaluate_trained_model(log_dir=args.logdir)